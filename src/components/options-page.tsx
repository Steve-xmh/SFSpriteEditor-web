	...
	return (
		<>
			...
			<div>
				...
				<select
					onChange={(evt) => dispatch(setLanguage(evt.currentTarget.value))}
			...
			<div>
				<label>
					<FormattedMessage
						id="options.display-debug-message"
						defaultMessage='Display Debug Messages'
					/>
				</label>
				<input
					type='checkbox'
					checked={displayDebugMessages}
					onClick={() => dispatch(toggleOption("displayDebugMessages"))}
				/>
			</div>
			<div>
				<label>
					<FormattedMessage
						id="options.display-subsprite-bounds"
						defaultMessage='Display Subsprite bounds'
					/>
				</label>
				<input
					type='checkbox'
					checked={showSubSpriteBounds}
					onClick={() => dispatch(toggleOption("showSubSpriteBounds"))}
				/>
			</div>
		</>
	);
