...
const errorMessages = defineMessages({
	...
	2: {
		...
		defaultMessage:
			"Tilesets header position {address} overflowed with file size {fileSize}",
	},
	3: {
		id: "error.read-error.palettes-header-overflow",
		defaultMessage:
			"Palettes header position {address} overflowed with file size {fileSize}",
	},
	4: {
		id: "error.read-error.sprites-header-overflow",
		defaultMessage:
			"Sprites header position {address} overflowed with file size {fileSize}",
	},
	5: {
		id: "error.read-error.animations-header-overflow",
		defaultMessage:
			"Animations header position {address} overflowed with file size {fileSize}",
	},
	6: {
		id: "error.read-error.palettes-address-overflow",
		defaultMessage:
			"Palettes address overflowed with {address} and file size is {fileSize}",
	},
	7: {
		id: "error.read-error.sprites-address-overflow",
		defaultMessage:
			"Sprites address overflowed with {address} and file size is {fileSize}",
	},
	8: {
		id: "error.read-error.tilesets-address-overflow",
		defaultMessage:
			"Tilesets address overflowed with {address} and file size is {fileSize}",
	},
	9: {
		id: "error.read-error.tilesets-eof",
		defaultMessage:
			"Met end of file while reading tileset {tilesetId} at {address} and file size is {fileSize}",
	},
	10: {
		id: "error.read-error.tilesets-wrong-position",
		defaultMessage:
			"Tileset {tilesetId} at {address} is not at the expected position and file size is {fileSize}",
	},
	11: {
		id: "error.read-error.tilesets-wrong-size",
		defaultMessage:
			"Size of tileset {tilesetId} at {address} is incorrect ({size}) and file size is {fileSize}",
	},
	12: {
...
export const LoadingDialog: FunctionComponent = (props) => {
	...
	return (
		<Dialog closable={!loading} dialogId="loading">
			{loading ? (
				<>
				...
				<div className={styles.errorPage}>
					<FormattedMessage
						id="loading.error-msg"
						defaultMessage="{amount, plural, =0 {No files} one {A file} two {Two files} other {{amount} files}} can't be opened, click other area to close and select opened file to go on"
						values={{ amount: errors.length }}
					/>
					<div className={styles.errors}>
						{errors.map((error, i) => (
							<div key={i}>
								...
								<div>
									<FormattedMessage
										{...errorMessages[error.error.errorId]}
										values={{ ...error.error }}
									/>
								</div>
							</div>
